          ...
          .map((book) => (
            ...
            <div style={styles.content}>
              <div style={styles.textSection}>
                ...
                <p style={styles.recent}>최근 대출: {book.lastLoan || '0000.00.00'}</p>
                <p style={styles.discard}>폐기 후보 점수: {book.discardScore}점</p>
              </div>
              <div style={styles.actionSection}>
                ...
                <div style={styles.iconRow}>
                  ...
                  <div onClick={() => toggleBookmark(book.id)} style={styles.icon}>
                    {bookmarks[book.id] ? <FaBookmark color="#333" /> : <FaRegBookmark />}
                  </div>
                </div>
              </div>
            </div>
